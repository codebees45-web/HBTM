...
export default function Profile() {
  const { state, updateProfile, resetProgress } = useApp()
  ...
  function handleSave(e) {
    e.preventDefault()
    updateProfile({ name: name.trim() || 'Learner', email: email.trim(), dailyGoalMinutes: Number(dailyGoalMinutes) || 0, remindersEnabled })
    setSaved(true)
